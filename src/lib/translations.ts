    ...
    subscriptionsPage: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ["Full gym access", "1 PT session", "1 InBody scan", "5 guest invitations", "Freeze up to 2 weeks", "Locker room access"],
        },
        {
          slug: "6-months",
          ...
          features: ["Full gym access", "2 PT sessions", "2 InBody scans", "15 guest invitations", "Freeze up to 4 weeks", "Locker room access"],
        },
        {
          slug: "1-year",
          ...
          features: ["Full gym access", "4 PT sessions", "4 InBody scans", "25 guest invitations", "Freeze up to 8 weeks", "Locker room access"],
        },
      ],
      ...
      plans: [
        {
          ...
          features: ["دخول كامل للجيم", "دخول غرفة الخزائن"],
        },
        {
          slug: "3-months",
          motivational: "ابني الزخم",
          tagline: "٣ شهور هي اللي بيحصل فيها التغيير الحقيقي. وقت كافي تشوف نتائج وتحب العملية.",
          features: ["دخول كامل للجيم", "جلسة تدريب شخصي واحدة", "تحليل InBody واحد", "5 دعوات للأصدقاء", "تجميد لحد أسبوعين", "دخول غرفة الخزائن"],
        },
        {
          slug: "6-months",
          motivational: "اتحوّل كليًا",
          tagline: "نص سنة من التفاني. هنا هتبص في المرايا وتشوف شخص جديد بيبصلك.",
          features: ["دخول كامل للجيم", "جلستين تدريب شخصي", "تحليلين InBody", "15 دعوة للأصدقاء", "تجميد لحد 4 أسابيع", "دخول غرفة الخزائن"],
        },
        {
          slug: "1-year",
          motivational: "التزم بالعظمة",
          tagline: "سنة كاملة من التحوّل. الالتزام الأقصى عشان تبقى أحسن نسخة من نفسك.",
          features: ["دخول كامل للجيم", "4 جلسات تدريب شخصي", "4 تحليلات InBody", "25 دعوة للأصدقاء", "تجميد لحد 8 أسابيع", "دخول غرفة الخزائن"],
        },
      ],
