              ...
              return (
                ...
                >
                  ...
                  <a
                    ...
                    className="w-full rounded-md bg-[#CC2421] py-3 text-sm font-semibold text-[#F6E8D1] text-center hover:bg-[#a01d1a] transition-colors flex items-center justify-center gap-2"
                  >
